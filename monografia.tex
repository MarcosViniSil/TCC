...
% ---
\titulo{Comparação entre modelos de tradução neurais baseados na arquitetura transformer de código aberto}
...
% ---
\input{1-Pre-Textual/aprovacao.tex}
% ---
...
% Dedicatória
% ---
%\input{1-Pre-Textual/Dedicatoria}
% ---
...
% Agradecimentos
% ---
%\input{1-Pre-Textual/Agradecimentos}
% ---
...
%\input{1-Pre-Textual/Resumo.tex}
% ---
...
% ----------------------------------------------------------
\chapter{Evolução da Tradução Automática}
\input{2-Textual/2-estado-arte.tex}

\chapter{Referencial teórico}
\input{2-Textual/3-Referencial-Teorico}
