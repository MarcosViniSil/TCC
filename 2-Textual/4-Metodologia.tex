...
\begin{itemize}
    ...
    \item \textbf{Textos específicos}: textos associados a domínios especializados, como medicina, engenharia, computação e nutrição, também obtidos a partir de bases de dados públicas.
