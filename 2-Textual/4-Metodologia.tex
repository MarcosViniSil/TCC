...
referencia = [['Uma', 'raposa', 'pula', 'sobre', 'o', 'cachorro', 'preguicoso', '.']]
geradoPeloModelo = ['Uma', 'pula','raposa', 'sobre', 'o', 'cachorro', 'preguicoso', ',']
...
\hline
\textbf{Memória RAM} & \textbf{Núcleos (vCPU)} & \textbf{Transferência de dados} & \textbf{Armazenamento} \\
\hline
16 GB & 8 vCPUs & 6 TB & 100 GB \\
\hline
\end{tabular}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, keepaspectratio]{Imagens/procedure.pdf}    \caption{\label{fig:procedimento} Procedimento}
    \legend{Fonte: autor}
\end{figure}
