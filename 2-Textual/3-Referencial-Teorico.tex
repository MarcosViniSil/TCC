...
\subsection{chrF}
    ...
    O cálculo da métrica chrF baseia-se na combinação de precisão e revocação de n-gramas de caracteres, resultando em uma medida do tipo F-score. Essa abordagem permite capturar similaridades entre palavras mesmo quando há pequenas variações, como flexões ou erros parciais na tradução \cite{emergentmind2026chrf}.
